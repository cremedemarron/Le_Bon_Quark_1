...
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    public function setSpaces(string $spaces): self
    {
        $this->spaces = $spaces;
    ...
    public function setHomePlanet(string $homePlanet): self
    {
    ...
    public function getGalacticCredit(): ?float
    {
        return $this->galacticCredit;
    }

    public function setGalacticCredit(?float $galacticCredit): self
    {
